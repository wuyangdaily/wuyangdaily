...
| [Agent](#agentuninstall) | [Moments-blog](#moments-blog) | [Mihomo](#mihomo-配置) | [Sub-Store](#sub-store订阅转换) | [Miaospeed](#miaospeed测速后端) | [Koipy](#koipy机器人配置) | [RustDesk](#rustdesk) | [DockUP](#dockup) |
| [配置文件](#配置文件) |  |  |
...
## [DockUP](https://github.com/shui1iao/DockUP)
[![GitHub release](https://img.shields.io/github/v/release/shui1iao/DockUP)](https://github.com/shui1iao/DockUP/releases)
```bash
docker run -d \
  --name dockup \
  -v /var/run/docker.sock:/var/run/docker.sock \
  ...
  --network=host \
  --restart=always \
  ghcr.io/shui1iao/dockup:latest
```
