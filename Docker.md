### Ubuntu Server 24.04 LTS 64_Docker Compose
```bash
...
### [Clash](https://github.com/MetaCubeX/mihomo) [配置](https://lanzoux.com/iqTc03kg1mpi)
...
### [Koipy](https://github.com/koipy-org/koipy)（机器人后端）[配置](https://lanzoux.com/iTsNq3kg1mib)
...
docker run -d \
  ...
  -v ./builtin:/app/resources/scripts/builtin \
  koipy/koipy:dev
```
